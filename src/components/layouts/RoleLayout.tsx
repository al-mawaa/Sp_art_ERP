...
import { Bell, ChevronDown, GraduationCap, LogOut, Menu, Palette, User, X, type LucideIcon } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex w-full bg-background">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden p-4 sm:p-6 max-w-full">
          {children}
        </main>
      </div>
    </div>

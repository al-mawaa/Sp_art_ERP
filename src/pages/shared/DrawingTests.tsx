      ...
      {loadingRecords ? (
        ...
        <div className="space-y-4">
          ...
          {records.map(record => (
            ...
            <div key={record.id} className="rounded-2xl border border-border p-5 bg-background shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                ...
                <div className="flex-1 min-w-0 space-y-3">
                  ...
                  <div>
                    ...
                    <h3 className="text-lg font-semibold">{record.testTitle || 'Drawing Assessment'}</h3>
                    ...
                    <div className="flex flex-wrap gap-x-4 gap-y-1 mt-2 text-sm text-muted-foreground">
                      ...
                      <span>Batch: {record.batchName || '—'}</span>



                      <span>Course: {record.courseName || '—'}</span>
                  ...
                  <div className="flex flex-wrap gap-x-4 gap-y-1 text-sm">
                    ...
                    <div>
                      ...
                      <span className="ml-1 font-medium">{record.timeTaken || 0} min</span>
                    ...
                    <div>
                      ...
                      <span className="ml-1 font-medium">{formatSubmittedAt(record.submittedAt || '')}</span>
                    ...
                    {record.evaluatedAt && (
                      ...
                      <div>
                        ...
                        <span className="ml-1 font-medium">{formatSubmittedAt(record.evaluatedAt)}</span>
                ...
                <div className="flex flex-col items-end gap-2 sm:min-w-[140px]">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-2xl font-bold">{record.evaluation ? `${record.evaluation.obtainedMarks}` : '—'}/{record.evaluation?.maxMarks ?? 30}</div>
                  ...
                  <a href={`/student/scores/${record.id}`} className="inline-block w-full sm:w-auto">



                    <Button className="rounded-xl w-full sm:w-auto">View Score</Button>

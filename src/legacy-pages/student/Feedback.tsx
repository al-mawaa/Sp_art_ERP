        ...
        <div className="p-5 sm:p-6 space-y-8">
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <RadioGroup value={motivated} onValueChange={(v: "Yes" | "Sometimes" | "No") => setMotivated(v)} className="flex gap-4 flex-wrap">
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <RadioGroup value={informed} onValueChange={(v: "Yes" | "No" | "Somewhat") => setInformed(v)} className="flex gap-4 flex-wrap">
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <RadioGroup value={recommend} onValueChange={(v: "Yes" | "Maybe" | "No") => setRecommend(v)} className="flex gap-4 flex-wrap">
                {["Yes", "Maybe", "No"].map(o => (
                  <label key={o} className="flex items-center gap-2 text-sm cursor-pointer"><RadioGroupItem value={o} />{o}</label>
                ))}
              </RadioGroup>

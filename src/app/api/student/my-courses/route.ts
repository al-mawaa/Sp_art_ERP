...
export async function GET(request: NextRequest) {
  try {
    ...
    const courses = await findMyCoursesForStudent(student);
    ...
    console.error("[student/my-courses GET]", e);
    return apiError("Failed to load my courses", 500);
  }
}

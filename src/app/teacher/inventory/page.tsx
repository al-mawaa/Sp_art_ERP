  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const [reqRes, issueRes] = await Promise.all([
        fetch("/api/teacher/inventory/requests"),
        fetch("/api/teacher/inventory/issues")
      ]);
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <PageHeader
          ...
          subtitle="Request items and materials for your classes"
        />
      ...
      <RequestItemModal
        ...
        apiEndpoint="/api/teacher/inventory"
      />
    </div>
  );
}
